...
(function () {
    ...
    function init() {
        ...
        $('lyh-dock-envelope').addEventListener('click', function () { todo('信箱'); });
        $('lyh-dock-diary').addEventListener('click', function () { todo('日志'); });
        $('lyh-dock-circle').addEventListener('click', function () { todo('朋友圈'); });
